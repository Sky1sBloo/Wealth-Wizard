...
namespace Wealth_Wizard.DisplayForms
{
    ...
    public partial class ManageSubscriptionsForm : Form
    {
        ...
        private void Btn_AddSub_Click(object sender, EventArgs e)
        {
            ...
            Tools.SubscriptionsHandler.AddNewSubscription(newSub);
        ...
        private void Btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                Tools.SubscriptionsHandler.EditSubscription(selectedSub, editSubscriptionForm.subscription);
            }
        ...
        private void Btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            foreach (int idx in selectedRowIdx)
            {
                ...
                Tools.SubscriptionsHandler.DeleteSubscription(selectedSub);
            }
